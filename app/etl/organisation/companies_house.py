...
class CompaniesHouseAccountsPipeline(L0IncrementalDataPipeline):
    ...
    _l0_data_column_types = [
        ...
        ('companies_house_registered_number', 'text'),
        ('entity_current_legal_name', 'text'),
        ('company_dormant', 'boolean'),
        ('average_number_employees_during_period', 'numeric'),
        ('tangible_fixed_assets', 'numeric'),
        ('debtors', 'numeric'),
        ('cash_bank_in_hand', 'numeric'),
        ('current_assets', 'numeric'),
        ('creditors_due_within_one_year', 'numeric'),
        ('creditors_due_after_one_year', 'numeric'),
        ('net_current_assets_liabilities', 'numeric'),
        ('total_assets_less_current_liabilities', 'numeric'),
        ('net_assets_liabilities_including_pension_asset_liability', 'numeric'),
        ('called_up_share_capital', 'numeric'),
        ('profit_loss_account_reserve', 'numeric'),
        ('shareholder_funds', 'numeric'),
        ('turnover_gross_operating_revenue', 'numeric'),
        ...
        ('tax_on_profit_or_loss_on_ordinary_activities', 'numeric'),
        ('profit_loss_for_period', 'numeric'),
    ]
