...
class TestWorldBankTariffTransform:
    ...
    def test_get_partner_reporter_combinations_for_each_year(self, app_with_db):
        ...
        wrapped_sql = f'with {sql} select reporter,partner,year from table_1 order by reporter, ' \
                      f'year'
    ...
    def test_get_rate_averages(self, app_with_db):
        ...
        wrapped_sql = f'with {year_sql}, {sql} select reporter, partner, year, bnd_rate from ' \
                      f'table_2'
